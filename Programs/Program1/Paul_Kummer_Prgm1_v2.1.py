...
def isValidPhone (phoneNumber):
	...
	#checks if phone number is long returns True or False
	...
	#checks if phone number is medium and returns True or False	
	...
	#checks if phone number is short and returns True or False						
